<template>
  <section class="privacy-wrapper">
    <div class="privacy">
      ...
      <p>Note that Joey Gauthier | Portfolio, Video Game Blog, &amp; Coding Blog has no access to or control over these cookies that are used by third-party advertisers.</p>
      ...
      <p>Joey Gauthier | Portfolio, Video Game Blog, &amp; Coding Blog's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options. You may find a complete list of these Privacy Policies and their links here: Privacy Policy Links.</p>
      ...
      <ul>
        <li>Joey Gauthier | Portfolio, Video Game Blog, &amp; Coding Blog needs to perform a contract with you</li>
        <li>You have given Joey Gauthier | Portfolio, Video Game Blog, &amp; Coding Blog permission to do so</li>
        <li>Processing your personal information is in Joey Gauthier | Portfolio, Video Game Blog, &amp; Coding Blog legitimate interests</li>
        <li>Joey Gauthier | Portfolio, Video Game Blog, &amp; Coding Blog needs to comply with the law</li>
      </ul>

      <p>Joey Gauthier | Portfolio, Video Game Blog, &amp; Coding Blog will retain your personal information only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use your information to the extent necessary to comply with our legal obligations, resolve disputes, and enforce our policies.</p>

      <p>If you are a resident of the European Economic Area (EEA), you have certain data protection rights. If you wish to be informed what Personal Information we hold about you and if you want it to be removed from our systems, please contact us. Our Privacy Policy was generated with the help of GDPR Privacy Policy Generator , the GDPR Privacy Policy Template and the Privacy Policy Generator from TermsFeed.</p>
      ...
      <p>Joey Gauthier | Portfolio, Video Game Blog, &amp; Coding Blog legal basis for collecting and using the personal information described in this Privacy Policy depends on the Personal Information we collect and the specific context in which we collect the information:</p>

      <h2>Log Files</h2>

      <p>Joey Gauthier | Portfolio, Video Game Blog, &amp; Coding Blog follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services' analytics. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site, tracking users' movement on the website, and gathering demographic information.</p>

      <h2>Cookies and Web Beacons</h2>

      <p>Like any other website, Joey Gauthier | Portfolio, Video Game Blog, &amp; Coding Blog uses 'cookies'. These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information.</p>
      ...
      <p>Joey G P&B uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>Joey G P&B will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

      <h2>Disclosure Of Data</h2>

      <h3>Legal Requirements</h3>
      <p>Joey G P&B may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of Joey G P&B</li>
